...
class Function : public CWrapper<Function> {
 ...
 public:
    ...
    GJS_JSAPI_RETURN_CONVENTION
    static bool invoke_finish_uncached(JSContext* cx, GICallableInfo* info,
                                       JS::HandleObject obj,
                                       GAsyncResult* result,
...
bool Function::invoke(JSContext* context, const JS::CallArgs& args,
    ...
    } else if (g_callable_info_is_async(m_info)) {
...
bool gjs_invoke_finish_from_c(JSContext* context, GICallableInfo* info,
